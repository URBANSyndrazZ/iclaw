...
describe('PWA cache retirement', () => {
  ...
  test('recognizes only iclaw legacy caches and registrations', () => {
    expect(
    ...
    const appScope = 'https://example.com/iclaw/';
    ...
    expect(isLegacyiclawRegistration(registration, appScope, scriptUrl)).toBe(
      true,
    );
    expect(
      isLegacyiclawRegistration(
