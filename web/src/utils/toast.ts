...
const OWNER_KEY = 'iclaw:bg-task-notice-owner';
...
export function showToast(
  ...
  if (link) {
    ...
    linkEl.style.cssText =
      'display:inline-block;margin-top:6px;font-size:13px;color:#60a5fa;' +
...
export function showNotificationPromptToast(): void {
  ...
  btn.style.cssText =
    ...
    'background:#60a5fa;color:#0b1220;font-size:13px;font-weight:600;cursor:pointer;';
