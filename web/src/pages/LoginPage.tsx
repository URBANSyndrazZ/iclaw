            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-6 lg:mt-8 hidden sm:flex items-center justify-center lg:justify-start gap-6 lg:gap-8">
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">每批简历</div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">面试轮次</div>
                </div>
                <div className="w-px h-8 bg-border" />
                <div>
                  <div className="text-xl lg:text-2xl font-bold text-foreground">
