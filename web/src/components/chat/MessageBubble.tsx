...
export const MessageBubble = memo(
  function MessageBubble({
    ...
    const hasOnlyImages =
      !presentedContent.trim() && images.length > 0 && documents.length === 0;
                ...
                <div className="mb-2 flex flex-wrap justify-end gap-2">
                  {documents.map((doc) => (
                    <span
                      ...
                      className="inline-flex max-w-[220px] items-center gap-1 rounded-lg border bg-background px-2 py-1 text-xs"
                    >
