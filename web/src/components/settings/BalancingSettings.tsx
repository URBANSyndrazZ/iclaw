    ...
    <div className="border border-border rounded-lg overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-brand-100 text-brand-700 dark:bg-brand-700/30 dark:text-brand-300">
      ...
      {expanded && (
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            {balancing.strategy === 'weighted-round-robin' && (
              <div className="mt-2 px-3 py-2 rounded-md border border-brand-200 dark:border-brand-700/40 bg-brand-50 dark:bg-brand-700/20 text-xs text-brand-700 dark:text-brand-300">
