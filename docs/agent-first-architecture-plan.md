...
- The effective-capability preview resolves host, iclaw-managed, and workspace project layers,
...
- Agent-level tool security modes have been removed. Bash, file writes, web access, sub-Agents,
  built-in iclaw tools and plugins are not reduced by AgentProfile configuration.
