...
const DocumentAttachmentSchema = z.object({
  ...
  attachmentId: z.string().regex(/^[0-9a-f-]{36}\.(pdf|doc|docx|txt|md)$/),
...
export const iclawOwnerProfileMutationSchema = z.discriminatedUnion('action', [
  z
    .object({
...
export const GroupPatchSchema = z.object({
  ...
  hr_agent_enabled: z.boolean().optional(),
  activation_mode: z
