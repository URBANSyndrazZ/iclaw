 ...
 *      marker = runtime/{userId}/snapshots/{snapshotId}/@iclaw-runtime-markers/{mp}/{plugin}.json
 ...
 */
const MARKER_DIRNAME = '@iclaw-runtime-markers';
...
/** runtime/{userId}/snapshots/{snapshotId}/@iclaw-runtime-markers/{mp}/{plugin}.json */
