...
/**
 * Claude-native MCP is project/host context, not a iclaw-managed user MCP
 * grant.  Materialize it explicitly so strict Agent MCP filtering cannot hide
 * it (and cannot accidentally re-enable unselected iclaw user servers).
...
/** iclaw-managed MCP is an additive final layer. */
