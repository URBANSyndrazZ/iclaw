/**
 * Shared types for iclaw Agent Runner.
 *
...
/**
 * Sanitized, per-input-turn channel identity supplied by the iclaw host.
 *
...
export function formatChannelTurnContextForPrompt(
  ...
  if (!context) return '';
  return [
    '<channel_context source="iclaw_host" trust="verified">',
...
export interface ContainerInput {
   ...
   * effective top-level AgentProfile is the built-in main iclaw. */
  ...
  /** Canonical effective Skill set resolved by the iclaw host. */
