...
const WRITE_TOOLS = new Set([
  'mcp__iclaw__workspace_memory_remember',
  'mcp__iclaw__workspace_memory_update',
  'mcp__iclaw__workspace_memory_forget',
]);
const OWNER_PROFILE_TOOLS = new Set([
  'mcp__iclaw__iclaw_owner_profile',
]);
      ...
      return {
        hookSpecificOutput: {
          ...
          permissionDecisionReason: ownerProfile
            ? 'Owner Profile is private to the actual owner’s top-level iclaw turn and is unavailable to sub-agents.'
